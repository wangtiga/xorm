...
var (
	oracle_12_1_ReservedWords = map[string]bool{
		"ACCESS":                    true,
		"ACCOUNT":                   true,
		"ACTIVATE":                  true,
		"ADD":                       true,
...
type oracle_12_1 struct {
	core.Base
}

func (db *oracle_12_1) Init(d *core.DB, uri *core.Uri, drivername, dataSourceName string) error {
	return db.Base.Init(d, db, uri, drivername, dataSourceName)
}

func (db *oracle_12_1) SqlType(c *core.Column) string {
	var res string
...
func (db *oracle_12_1) AutoIncrStr() string {
	return "AUTO_INCREMENT"
}

func (db *oracle_12_1) SupportInsertMany() bool {
	return true
}

func (db *oracle_12_1) IsReserved(name string) bool {
	_, ok := oracle_12_1_ReservedWords[name]
	return ok
}

func (db *oracle_12_1) Quote(name string) string {
	// return "\"" + name + "\""
	return name
}

func (db *oracle_12_1) QuoteStr() string {
	// return "\""
	return ""
}

func (db *oracle_12_1) SupportEngine() bool {
	return false
}

func (db *oracle_12_1) SupportCharset() bool {
	return false
}

func (db *oracle_12_1) SupportDropIfExists() bool {
	return false
}

func (db *oracle_12_1) IndexOnTable() bool {
	return false
}

func (db *oracle_12_1) DropTableSql(tableName string) string {
	return fmt.Sprintf("DROP TABLE `%s`", tableName)
}

func (db *oracle_12_1) CreateTableSql(table *core.Table, tableName, storeEngine, charset string) string {
	var sql string
	sql = "CREATE TABLE "
	if tableName == "" {
...
func (db *oracle_12_1) IndexCheckSql(tableName, idxName string) (string, []interface{}) {
	args := []interface{}{tableName, idxName}
	return `SELECT INDEX_NAME FROM USER_INDEXES ` +
		`WHERE TABLE_NAME = :1 AND INDEX_NAME = :2`, args
}

func (db *oracle_12_1) TableCheckSql(tableName string) (string, []interface{}) {
	args := []interface{}{tableName}
	return `SELECT table_name FROM user_tables WHERE table_name = :1`, args
}

func (db *oracle_12_1) MustDropTable(tableName string) error {
...
/*func (db *oracle_12_1) ColumnCheckSql(tableName, colName string) (string, []interface{}) {
...
func (db *oracle_12_1) IsColumnExist(tableName, colName string) (bool, error) {
...
func (db *oracle_12_1) GetColumns(tableName string) ([]string, map[string]*core.Column, error) {
	args := []interface{}{tableName}
...
func (db *oracle_12_1) GetTables() ([]*core.Table, error) {
	args := []interface{}{}
...
func (db *oracle_12_1) GetIndexes(tableName string) (map[string]*core.Index, error) {
	args := []interface{}{tableName}
...
func (db *oracle_12_1) Filters() []core.Filter {
	return []core.Filter{&core.QuoteFilter{}, &core.SeqFilter{Prefix: ":", Start: 1}, &core.IdFilter{}}
}

type goracle_12_1_Driver struct {
}

func (cfg *goracle_12_1_Driver) Parse(driverName, dataSourceName string) (*core.Uri, error) {
	db := &core.Uri{DbType: core.ORACLE_12_1}
	// dataSourceName := "YTX_CONF_DEV/123456@(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=192.168.180.150)(PORT=1523))(CONNECT_DATA=(SID=ora11g)))"
	// 为了动手动脚上面的格式，不解析 db.DbName 。因为oracle并未真正用到 db.DbName
	return db, nil
